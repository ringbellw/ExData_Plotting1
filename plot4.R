...
legend(x = mean(sub_data$Date_Time), y = 40, legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),
       col = c("black", "red", "blue"), lty = 1, lwd = 2.5, seg.len = 0.5, bty = "n", y.intersp = 0.8)
